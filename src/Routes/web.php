...
Route::group(['prefix' => 'install', 'as' => 'LaravelInstaller::', 'namespace' => 'DocSchema\Controllers', 'middleware' => ['web', 'install']], function () {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update', 'as' => 'LaravelUpdater::', 'namespace' => 'DocSchema\Controllers', 'middleware' => 'web'], function () {
